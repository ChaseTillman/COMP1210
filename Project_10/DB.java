 ...
 * Has defined natural order by names with compareTo method.
 *
 * Project_10
 *
...
public abstract class DB implements Comparable<DB> {
   ...
   /**
    * Compares the names of the two databases.
    * @param obj - Database to compare its name.
    * @return - Negative: This name is greater. Positive: Obj name greater.
    * Zero: Both names are same.
    */
