...
/**
 * JUnit test for the HomogeneousDB class.
 * 
 * Project_09
 *
...
public class HomogeneousDBTest {
  ...
  /**
   ...
   @Test public void getNameTest() {
      HomogeneousDB db1 = new HomogeneousDB("DB", 100, 5, 10, 12.);
   ...
   @Test public void monthlyCostTest() {
      HomogeneousDB db1 = new HomogeneousDB("DB", 2000.0, 7.5, 100, 12.0);
      Assert.assertEquals(db1.monthlyCost(), 3440., 0.000001);
   }
   ...
   @Test public void toStringTest() {
      HomogeneousDB db1 = new HomogeneousDB("DB", 1200, 5, 1500, 12.);
   ...
   @Test public void getCostFactorTest() {
      HomogeneousDB db1 = new HomogeneousDB("DB", 1200, 5, 1500, 12.);
      Assert.assertEquals(db1.getCostFactor(), 1.2, 0.000001);
   }
   ...
   @Test public void getCountTest() {
      Assert.assertEquals(HomogeneousDB.getCount(), 14);
   }
   ...
   @Test public void resetCountTest() {
      HomogeneousDB.resetCount();
      Assert.assertEquals(HomogeneousDB.getCount(), 0);
   }
}
